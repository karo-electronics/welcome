...
sources as available from `Kernel.org <https://kernel.org>`_
...
:raw-html-m2r:`<a id="source"></a>`
Source: https://www.karo-electronics.de/1651.html

:raw-html-m2r:`<a name="pcn">PCN</a>`\ :
...
`Ka-Ro electronics GmbH <https://www.karo-electronics.de>`_
